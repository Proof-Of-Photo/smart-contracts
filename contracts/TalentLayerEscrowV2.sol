...
import "./interfaces/IERC20FeeProxy.sol";
 ...
 */
contract TalentLayerEscrowV2 is
    Initializable,
    ...
    IArbitrable
{
    ...
    IERC20FeeProxy public erc20PaymentProxy;
    IEthereumFeeProxy public ethPaymentProxy;
    ...
    function initialize(
        ...
        IERC20FeeProxy _erc20PaymentProxy,
        IEthereumFeeProxy _ethPaymentProxy
    ) public initializer {
        __Ownable_init();
    ...
    function createTransaction(
        ...
        if (proposal.rateToken != address(0)) {
            (bool status, ) = address(erc20PaymentProxy).delegatecall(
